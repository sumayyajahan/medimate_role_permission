...
$sql = "SELECT * FROM user_account WHERE account_active_status = 5";
            ...
            <div class="main-content">
                <section class="section">
                    <ul class="breadcrumb breadcrumb-style ">
                        ...
                        <li class="breadcrumb-item">Closing Request</li>
                    </ul>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Closing Requested Accounts</h4>
                                    </div>
                                    <div class="card-body">
        ...
        function cancel(user_id) {
            $.ajax({
                ...
                success: function(result) {
                    ...
                    Swal.fire(
                        result,
                        'Redirecting to Closing Requested Page',
                        'success'
                    ).then(function() {
                        window.location = "./closing-request.php";
                    })
