              ...
              <div class="card-body">
                <form method="POST" action="./dashboard.php" class="needs-validation" novalidate="">
                  <div class="form-group">
                    ...
                    <input id="email" type="text" class="form-control" name="id" tabindex="1" required autofocus>
                  ...
                  <div class="form-group">
                    <button type="submit" name="login" class="btn btn-primary btn-lg btn-block" tabindex="3">
                      Login
                    </button>
                  </div>
                </form>
