...
@section('title','Reschedule Appointments')
@section('content')
                        ...
                        <table id="tableExport" class="table table-striped table-hover" id="" style="width:100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{date('d M y',strtotime($appointmentSchedule->reschedule_date))}}

                                        <br>

                                        {{date('h:i a',strtotime($appointmentSchedule->reAppointmentSlot->start_time))}}
                                        -
                                        {{date('h:i a',strtotime($appointmentSchedule->reAppointmentSlot->end_time))}}
                                    </td>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        {{-- <a href="route('admin.appointment-schedule.show',$appointmentSchedule->id) ">
                                            ...
                                            --}}
                                        <a target="_blank"
                                            href="{{route('admin.appointment-schedule.approve.reschedule',$appointmentSchedule->id)}}">
                                        ...
                                        <a
                                            ...
                                            <button class="m-1 btn btn-white"><img src="/icons/cancel.png" style="width:50px;"></button></a>
