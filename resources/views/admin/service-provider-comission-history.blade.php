...
@section('title','Service Provider Comission Record')
@section('content')
@include('includes.banner',['one'=>'Service Provider Comission Record','two'=>'View'])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Service Provider Comission Record</h4>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-striped table-hover" id="tableExportReport" style="width:100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$log->type}}</td>
                                    <td>{{$log->recharge_amount}}</td>
                                    <td>{{$log->comission_percentage}}%</td>
                                    <td>{{$log->comission_amount}}</td>
