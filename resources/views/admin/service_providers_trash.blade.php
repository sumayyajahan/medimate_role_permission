...
@section('title','Manage Trashed Service Providers')
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header" style="justify-content: space-between;">
                    <b style="font-size:large;">Manage Trashed Service Providers Accounts</b>
                    {{-- <span><a class="btn btn-success" href="{{route('admin.service-provider.create')}}">Add Service
                    Provider</a></span> --}}
                </div>
                <div class="card-body">
                        ...
                        <table id="tableExport" class="table table-striped table-hover" id="" style="width:100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        {{-- <a href="{{route('admin.service-provider.show',$serviceProvider->id)}}">
                                        <button class="m-1 btn btn-white"> <img src="/icons/view.png"
                                        ...
                                        <form id="delete-form-{{$serviceProvider->id}}"
                                            action="{{ route('admin.service-provider.forceDelete',$serviceProvider->id) }}"
