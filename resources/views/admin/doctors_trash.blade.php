...
@section('title','Manage Trashed Doctors')
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header" style="justify-content: space-between;">
                    <b style="font-size:large;">Manage Trashed Doctor Accounts</b>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <form id="delete-form-{{$doctor->id}}"
                                            action="{{ route('admin.doctor.forceDelete',$doctor->id) }}" method="POST"
                                            style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
