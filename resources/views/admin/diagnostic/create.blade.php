...
@section('title','Add Diagnostic Service')
@section('content')
    @include('includes.banner',['one'=>'Diagnostic','two'=>'Create'])

    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <form  class="form-group" action="{{route('admin.diagnostic.store')}}" method="post"
                       enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <h4>Add Diagnostic Service</h4>
                        </div>
                        <div class="card-body">
