                                            ...
                                            <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>0125479654</td>
                                                        <td>House 632, Mirpur Dohs</td>
                                                        <td>1030</td>
                                                        <td class="d-flex justify-content-around">
                                                            <a target="_blank" href="view-user.php?user_id=1"> <button class="m-2 btn btn-outline-secondary">View more</button></a>
                                                            <a href="edit-user-info.php?user_id=1"> <button class="m-2 btn btn-outline-warning">Edit User</button></a>
                                                            <a target="_blank" href="user-wallet-history.php?user_id=1"> <button class="m-2 btn btn-outline-info">Wallet History</button></a>
