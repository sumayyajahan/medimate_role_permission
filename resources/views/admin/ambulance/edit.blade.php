...
@section('title','Edit ambulance Service')
@section('content')
    @include('includes.banner',['one'=>'ambulance','two'=>'Edit'])

    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <form class="form-group" action="{{route('admin.ambulance.update',$content->id)}}" method="post"
                      enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit ambulance Service</h4>
                        </div>
                        <div class="card-body">
