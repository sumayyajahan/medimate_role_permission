                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{date('h:i a',strtotime($appointmentSchedule->appointmentSlot->start_time))}} -
                                        {{date('h:i a',strtotime($appointmentSchedule->appointmentSlot->end_time))}}</td>
                                    <td>{!!$appointmentSchedule->consult == 1 ? "<span class='m-1 btn btn-primary'>Yes</span>":"<span class='m-1 btn btn-danger'>No</span>"!!}</td>
