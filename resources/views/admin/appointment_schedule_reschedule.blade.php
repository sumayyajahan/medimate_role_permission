...
@section('title','Reschedule Appoinment ')
@section('content')
@include('includes.banner',['one'=>'Reschedule','two'=>'Appoinment'])
<style>
            ...
            <form class="form-group" action="{{route('admin.appointment-schedule.update',$appointmentSchedule->id)}}" method="POST" autocomplete="off">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Reschedul Date</label>
                            <input required value="{{$appointmentSchedule->reschedul_date}}" class="col-md-6 form-control" id="" name="date" type="date" data-input />
                        </div>
                        ...
                        <input type="hidden" name="reschedule" value="0" id="">


                    </div>
                    <div class="card-footer text-left">
                        <button class="btn btn-success mr-1" type="submit" name="grant">Reschedul Appointment</button>
                    </div>
                </div>
            </form>
        </div>
