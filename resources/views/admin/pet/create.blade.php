...
@section('title','Add Pet Service')
@section('content')
    @include('includes.banner',['one'=>'Pet','two'=>'Create'])

    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <form  class="form-group" action="{{route('admin.pet.store')}}" method="post"
                       enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <h4>Add Pet Service</h4>
                        </div>
                        <div class="card-body">
