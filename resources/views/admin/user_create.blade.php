...
@section('content')
@include('includes.banner',['one'=>'User','two'=>'Create'])
<div class="section-body">
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            <form id="add-account" class="form-group" action="{{ route('admin.user.store') }}" method="post"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('mobile') ?? '+880' }}" type="text" class="form-control" name="mobile" minlength="14" placeholder="+8801XXXXXXXXX" required>
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('district') }}" type="text" class="form-control" name="district"
                                id="district">
                        </div>

                        <div class="form-group">
                            <label>Police Station</label>
                            <input value="{{ old('police_station') }}" type="text" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('post_office') }}" type="text" class="form-control" name="post_office"
                                id="post_office">
